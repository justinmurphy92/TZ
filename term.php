...
<p>
<strong>1.0</strong> Introduction<br/><br/>
<strong>1.1</strong>	These terms and conditions shall govern your use of our website.<br/><br/>
<strong>1.2</strong>	By using our website, you accept these terms and conditions in full; accordingly, if you disagree with these terms and conditions or any part of these terms and conditions, you must not use our website.<br/><br/>
<strong>1.3</strong>	If you [register with our website, submit any material to our website or use any of our website services], we will ask you to expressly agree to these terms and conditions.<br/><br/>
<strong>1.4</strong>	You must be at least 18 years of age (or have permission from a legal gaurdian) to use our website; and by using our website or agreeing to these terms and conditions, you warrant and represent to us that you are at least 18 years of age or have the consent of a legal gaurdian.<br/><br/>
<strong>2.1</strong>	Copyright (c) 2014 Justin Murphy & Adam Howatt.<br/><br/>
<strong>2.2</strong>	Subject to the express provisions of these terms and conditions:<br/>
<i>(a)</i>	we, together with our licensors, own and control all the copyright and other intellectual property rights in our website and the material on our website; and<br/>
<i>(b)</i>	all the copyright and other intellectual property rights in our website and the material on our website are reserved.<br/><br/>
<strong>3.0</strong>	Licence to use website<br/><br/>
<strong>3.1</strong>	You may:<br/><br/>
<i>(a)</i>	view pages from our website in a web browser;<br/>
<i>(b)</i>	download pages from our website for caching in a web browser;<br/>
<i>(c)</i>	print pages from our website;<br/>
<i>(d)</i>	stream audio and video files from our website; and<br/>
subject to the other provisions of these terms and conditions.<br/><br/>
...
<strong>4.5</strong>	Unless you own or control the relevant rights in the material, you must not:<br/>
<i>(a)</i>	republish material from our website (including republication on another website);<br/>
<i>(b)</i>	sell, rent or sub-license material from our website;<br/>
<i>(c)</i>	show any material from our website in public;<br/>
<i>(d)</i>	exploit material from our website for a commercial purpose; or<br/>
<i>(e)</i>	redistribute material from our website.<br/>
<strong>4.6</strong>	We reserve the right to restrict access to areas of our website, or indeed our whole website, at our discretion; you must not circumvent or bypass, or attempt to circumvent or bypass, any access restriction measures on our website.<br/>
<strong>5.0</strong>	Acceptable use<br/>
<strong>5.1</strong>	You must not:<br/>
<i>(a)</i>	use our website in any way or take any action that causes, or may cause, damage to the website or impairment of the performance, availability or accessibility of the website;<br/>
<i>(b)</i>	use our website in any way that is unlawful, illegal, fraudulent or harmful, or in connection with any unlawful, illegal, fraudulent or harmful purpose or activity;<br/>
<i>(c)</i>	use our website to copy, store, host, transmit, send, use, publish or distribute any material which consists of (or is linked to) any spyware, computer virus, Trojan horse, worm, keystroke logger, rootkit or other malicious computer software;<br/>
<i>(d)</i>	conduct any systematic or automated data collection activities (including without limitation scraping, data mining, data extraction and data harvesting) on or in relation to our website without our express written consent;<br/>
<i>(e)</i>	access or otherwise interact with our website using any robot, spider or other automated means;<br/>
<i>(f)</i>	violate the directives set out in the robots.txt file for our website; or<br/>
<i>(g)</i>	use data collected from our website for any direct marketing activity (including without limitation email marketing, SMS marketing, telemarketing and direct mailing).<br/>
...
<strong>5.3</strong>	You must ensure that all the information you supply to us through our website, or in relation to our website, is [true, accurate, current, complete and non-misleading.<br/>
<strong>6.0</strong>	Registration and accounts<br/>
<strong>6.1</strong>	To be eligible for an individual account on our website under this Section 6, you must be at least 18 years of age or have permission from a legal gaurdian.<br/>
<strong>6.2</strong>	You may register for an account with our website by completing and submitting the account registration form on our website, and clicking on the verification link in the email that the website will send to you.<br/>
<strong>6.3</strong>	You must notify us in writing immediately if you become aware of any unauthorised use of your account.<br/>
<strong>6.4</strong>	You must not use any other person's account to access the website.<br/>
<strong>7.0</strong>	User IDs and passwords<br/>
<strong>7.1</strong>	If you register for an account with our website, [we will provide you with / you will be asked to choose] a user ID and password.
<strong>7.2</strong>	Your user ID must not be liable to mislead and must comply with the content rules set out in Section 10; you must not use your account or user ID for or in connection with the impersonation of any person.
<strong>7.3</strong>	You must keep your password confidential.
<strong>7.4</strong>	You must notify us in writing immediately if you become aware of any disclosure of your password.
<strong>7.5</strong>	You are responsible for any activity on our website arising out of any failure to keep your password confidential, and may be held liable for any losses arising out of such a failure.
<strong>8.0</strong>	Cancellation and suspension of account
<strong>8.1</strong>	We may:
<strong><i>(a)</i>	suspend your account;
