    ...
    if ($db)
    {
        try{
            ...
            if (empty($_POST['lessonMatchID']) || empty($_POST['lessonSubjectID']) || empty($_POST['lessonDate']) || empty($_POST['lessonLength']) || empty($_POST['lessonTitle'])){
                ...
                $tranID = createTransaction($_POST['lessonMatchID'], $_POST['lessonLength'], $_POST['lessonDate']);

                $insertSQL = "INSERT INTO lesson(match_id, subject_id, lesson_date, lesson_length, lesson_title, lesson_desc, lesson_location, lesson_comments, transaction_id) VALUES(:matchID, :subjectID, unix_timestamp(:lessonDate), :length, :title, :desc, :location, :comments, :transID)";
                ...
                $insertQuery->bindValue(':transID', $tranID);
